...
extern u8 TACTILE_u8GetState(u8 Copy_u8SwitchNumber, u8* Copy_u8PtrToVal) {
	/* Comment!: HOLD HIGH OR LOW */
	u8 copy_u8SwitchVal = DIO_u8LOW;
	/* Comment!: SWITCH ON STATE */
	switch (TACTILE_u8SwitchState[Copy_u8SwitchNumber]) {
	case TACTILE_u8SWITCHSTATERELEASED:
		TACTILE_u8ReturnVal[Copy_u8SwitchNumber] = //RETURN VAL IS RELEASED
				TACTILE_u8SWITCHRELEASED;
		*Copy_u8PtrToVal=TACTILE_u8ReturnVal[Copy_u8SwitchNumber]; //RETURN RELEASED
		DIO_u8ReadPinVal(TACTILE_u8SwitchPin[Copy_u8SwitchNumber], //READ SWITCH
				&copy_u8SwitchVal);
		//IF PRESSED CHANGE TO DEBOUNCING STATE
	...
	case TACTILE_u8SWITCHSTATEDEBOUNCING:
		...
		DIO_u8ReadPinVal(TACTILE_u8SwitchPin[Copy_u8SwitchNumber],
				&copy_u8SwitchVal);
		//IF HIGH..INCREASE COUNT UP...ELSE INCREAE COUNT DOWN
		if (copy_u8SwitchVal == TACTILE_u8SwitchType[Copy_u8SwitchNumber]) {
...
//IF COUNT UP REACHED MAX MOVE TO PRESSED
		...
		//IF COUNT DOWN REACHED MAX MOVE TO RELEASED
